...
export const chapter4BookSections: BookSection[] = [
  ...
  },
  {
    id: "c4-b6",
    chapterId: 4,
    title: "Дополнение: культура Российского государства",
    sortKey: 440,
    sourcePath: "books/russian-history/part-1/30.php.html",
  },
];
...
export const chapter4StudyCardTargets: Record<string, BookTarget> = {
  "c4-f1": { sectionId: "c3-b1", anchorId: "c3-kalka" },
  "c4-f2": { sectionId: "c3-b3", anchorId: "c3-neva" },
  "c4-f3": { sectionId: "c3-b8", anchorId: "c3-kulikovo" },
  "c4-f4": { sectionId: "c4-b3", anchorId: "c4-ugra" },
  "c4-f5": { sectionId: "c4-b2", anchorId: "c4-autocephaly" },
  "c4-f6": { sectionId: "c4-b2", anchorId: "c4-horde-fracture" },
  "c4-f7": { sectionId: "c4-b3", anchorId: "c4-novgorod" },
  "c4-f8": { sectionId: "c4-b3", anchorId: "c4-novgorod" },
  "c4-f9": { sectionId: "c4-b3", anchorId: "c4-tver" },
  ...
  "c4-f14": { sectionId: "c4-b4", anchorId: "c4-government" },
  "c4-f15": { sectionId: "c4-b4", anchorId: "c4-mestnichestvo" },
  "c4-f16": { sectionId: "c4-b4", anchorId: "c4-service-people" },
  "c4-f17": { sectionId: "c4-b3", anchorId: "c4-tver" },
  "c4-f18": { sectionId: "c4-b5", anchorId: "c4-smolensk" },
  "c4-f19": { sectionId: "c4-b4", anchorId: "c4-heresy" },
  "c4-f20": { sectionId: "c4-b6", anchorId: "c4-fioravanti" },
  "c4-f21": { sectionId: "c4-b3", anchorId: "c4-symbols" },
  "c4-f22": { sectionId: "c4-b6", anchorId: "c4-shatry" },
  "c4-f23": { sectionId: "c1-b6", anchorId: "c1-sofia-kiev" },
  "c4-f24": { sectionId: "c2-b2", anchorId: "c2-vladimir-cathedral" },
  "c4-f25": { sectionId: "c4-b6", anchorId: "c4-fioravanti" },
  "c4-f26": { sectionId: "c4-b6", anchorId: "c4-kolomenskoye" },
};

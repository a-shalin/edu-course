...
export const chapter3StudyCardTargets: Record<string, BookTarget> = {
  "c3-f1": { sectionId: "c3-b1" },
  "c3-f2": { sectionId: "c3-b1" },
  "c3-f3": { sectionId: "c3-b2" },
  "c3-f4": { sectionId: "c3-b2" },
  "c3-f5": { sectionId: "c3-b2" },
  "c3-f6": { sectionId: "c3-b2" },
  "c3-f7": { sectionId: "c3-b2" },
  "c3-f8": { sectionId: "c3-b3" },
  "c3-f9": { sectionId: "c3-b3" },
  "c3-f10": { sectionId: "c3-b4" },
  "c3-f11": { sectionId: "c3-b4" },
  "c3-f12": { sectionId: "c3-b4" },
  "c3-f13": { sectionId: "c3-b4" },
  "c3-f14": { sectionId: "c3-b4" },
  "c3-f15": { sectionId: "c3-b4" },
  "c3-f16": { sectionId: "c3-b4" },
  "c3-f17": { sectionId: "c3-b7" },
  "c3-f18": { sectionId: "c3-b7" },
  "c3-f19": { sectionId: "c1-b6" },
  "c3-f20": { sectionId: "c3-b8" },
  "c3-f21": { sectionId: "c3-b3" },
  "c3-f22": { sectionId: "c3-b8" },
  "c3-f23": { sectionId: "c3-b8" },
  "c3-f24": { sectionId: "c3-b8" },
  "c3-f25": { sectionId: "c1-b6" },
  "c3-f26": { sectionId: "c4-b3" },
  "c3-f27": { sectionId: "c3-b2" },
  "c3-f28": { sectionId: "c1-b4" },
  "c3-f29": { sectionId: "c1-b6" },
  "c3-f30": { sectionId: "c3-b3" },
  "c3-f31": { sectionId: "c3-b8" },
  "c3-f32": { sectionId: "c3-b1" },
  "c3-f33": { sectionId: "c4-b3" },
};

      ...
      <section className="mb-12 grid gap-6 lg:grid-cols-[1.5fr_0.9fr]">
        <div className="relative overflow-hidden rounded-[2.2rem] border border-border bg-card px-8 py-10 shadow-[0_24px_90px_rgba(59,37,26,0.12)] lg:px-10 lg:py-12">
          ...
          <div className="relative">
            ...
            <p className="max-w-2xl text-base leading-8 text-foreground/78 lg:text-lg">
              Каркас курса уже повторяет структуру RH9, но учебник и практика для шестого
              класса ещё не загружены. После импорта нового пособия сюда добавятся главы,
              хронологический обзор, опорные карточки и упражнения.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-[2.2rem] border border-border bg-burgundy px-8 py-10 text-white shadow-[0_24px_90px_rgba(92,34,29,0.24)]">
          ...
          <div className="mt-8 rounded-[1.5rem] border border-white/12 bg-white/8 p-5 text-sm leading-7 text-white/78">
            Пока в курсе нет наполненных глав: сначала нужно положить HTML учебника и
            контрольных работ в структуру `{TEXTBOOK_ROOT_PATH}`.
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-[1.8rem] border border-border bg-card p-7 shadow-[0_20px_60px_rgba(59,37,26,0.08)]">
          ...
          <p className="text-sm leading-7 text-foreground/78">
            После импорта источников каждая готовая глава будет начинаться со скрытого по
            умолчанию обзора по датам, затем пойдут опорные карточки в хронологическом порядке,
            а после них — практика по заданиям контрольной работы.
          </p>
        </div>
        ...
        <div className="rounded-[1.8rem] border border-border bg-card p-7 shadow-[0_20px_60px_rgba(59,37,26,0.08)]">
          ...
          <h3 className="mb-4 font-serif text-2xl font-bold text-foreground">
            Повторение структуры RH9
          </h3>
          <p className="text-sm leading-7 text-foreground/78">
            Новые главы можно будет собирать по той же логике: полный набор упражнений,
            фактические опорные карточки и общий обзор главы, чтобы сохранить единый формат
            курса.
          </p>
        </div>
      </section>

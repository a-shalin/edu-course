...
function BookTargetButton({
  ...
  return (
    <button
      ...
      data-testid="practice-open-book"
...
function SingleChoicePart({
  ...
  return (
    <div
      data-testid="practice-single-choice"
      className="space-y-4 rounded-[1.4rem] border border-border/90 bg-card px-5 py-5 shadow-[0_10px_30px_rgba(59,37,26,0.06)]"
    >
      {part.title ? (
      ...
      <div className="space-y-3">
        {part.options.map((option) => (
          <OptionButton
            key={option.label}
            testId={`practice-option-${option.label}`}
            label={option.label}
...
function MultiSelectPart({
  ...
  return (
    <div
      data-testid="practice-multi-select"
      className="space-y-4 rounded-[1.4rem] border border-border/90 bg-card px-5 py-5 shadow-[0_10px_30px_rgba(59,37,26,0.06)]"
    >
      {part.title ? (
        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted">
...
export function PracticeSession({
  ...
  return (
    <div
      ...
      className="rounded-[2rem] border border-border bg-card p-6 shadow-[0_20px_80px_rgba(59,37,26,0.08)] lg:p-8"
    >
      <ProgressBar {...stats} />

      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <h4
          data-testid="practice-question-title"
        ...
        <button
          type="button"
          onClick={handleResetProgress}
          data-testid="practice-reset-progress"
